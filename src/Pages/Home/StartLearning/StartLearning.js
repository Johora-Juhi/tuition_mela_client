    ...
    return (
        <div className='bg-sky-50 py-20'>
            <div className='flex flex-col lg:flex-row items-center mx-20 p-10 border border-sky-900 rounded-tl-3xl rounded-br-3xl'>
                ...
                <p className='text-stone-400'>Explore all of our Tuitions and pick your suitable ones to teach and start learning with us!</p>
                </div>
                <div className='text-end w-full lg:w-1/2'>
                <Link className="btn btn-accent rounded-none mt-7 text-slate-50" to="/tuitions">Start Learning Today</Link>
                </div>
            </div>
        </div>
    );
